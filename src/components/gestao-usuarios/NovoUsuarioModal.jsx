...
export default function NovoUsuarioModal({ condominios, residencias, onClose, onSave }) {
          ...
          <TabsContent value="basico" className="space-y-4 pt-4">
            ...
            <Alert className="bg-blue-50 border-blue-200">
              ...
              <AlertDescription className="text-blue-800 text-sm">
                💡 As permissões serão configuradas automaticamente com base no tipo de usuário.
                Você pode personalizá-las na aba "Permissões".
              </AlertDescription>
            </Alert>
          </TabsContent>
